<template>
  <div class="app-container">
    <el-button type="primary" @click="pageSomeAdd">新增版本</el-button>
    <el-table
      :data="apkList"
      ...
      ref="table"
    >
      <el-table-column align="center" prop="groupName" label="版本号"></el-table-column>
      <el-table-column align="center" prop="weight" label="版本名" width="80px"> </el-table-column>
      <el-table-column align="center" prop="createUser" label="文件下载地址"> </el-table-column>
      <el-table-column
        align="center"
        prop="createTime"
        label="更新详情"
      ...
      <el-table-column align="center" label="更新类型"> </el-table-column>
...
export default class AppList extends PageSome {
  appList: Array<Feedback> = []

  async getList() {
    // 获取列表
    const res = await getFeedbackListForPage(this.pageParams)
    if (!res) return
    this.appList = res.bodyMessage?.items
  ...
  dialogCancel(data) {
    ...
    this.$set(this.appList, this.nowEditIndex, data)
    this.nowEditIndex = -1
  }
